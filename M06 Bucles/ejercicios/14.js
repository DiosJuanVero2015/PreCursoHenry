...
/* console.log(operadoresLogicos(5,-2,2));// Retorna --> Numero 1 es mayor y positivo
console.log(operadoresLogicos(-4,8,7));// Retorna --> Hay negativos
console.log(operadoresLogicos(0,0,0));// Retorna --> Error
console.log(operadoresLogicos(2,3,5));// Retorna --> 6 */
